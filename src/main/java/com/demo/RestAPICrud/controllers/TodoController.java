package com.demo.RestAPICrud.controllers;

import com.demo.RestAPICrud.model.Todo;
import com.demo.RestAPICrud.services.TodoService;
...
public class TodoController {
    ...
    /*
    The following function receives a GET request, processes it and give back
     a list to Todo as a response.
    */
    @GetMapping
